...
- FR7: Librarians can view and manage the book catalog.
...
- FR12: The system sends notifications to members for due dates and available
  reservations.
...
## Constraints
- C1: Members can borrow up to 5 books at once (default rule).
- C2: Reservations expire after 3 days if not collected (default rule).
- C3: Loan period is 14 days from the borrow date (default rule).
